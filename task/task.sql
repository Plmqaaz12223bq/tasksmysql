...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2022 at 04:44 AM
...
CREATE TABLE `department` (
  ...
  `DEPARTMENT_NAME` int(255) NOT NULL,
...
INSERT INTO `county_new` (`country_id`, `COUNTRY_NAME`, `REGION_ID`) VALUES
('AR', 'Argentina', '2'),
('AU', 'Australia', '3'),
('BE', 'Belgium', '1'),
('BR', 'Brazil', '2'),
...
INSERT INTO `department` (`department_id`, `department_name`, `manegaer_id`, `location_id`) VALUES
...
ALTER TABLE `department`
  ADD PRIMARY KEY (`department_id`,`location_id`);
-- --------------------------------------------------------
